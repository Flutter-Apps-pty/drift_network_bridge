...
/// database requests.
@internal
class ServerNetworkImplementation implements DriftNetworkServer {
  ...
  final Set<DriftNetworkCommunication> _activeChannels = {};
  ...
  ServerNetworkImplementation(this.connection, this.allowRemoteShutdown,
  ...
  void dispatchTableUpdateNotification(NotifyTablesUpdated notification,
      [DriftNetworkCommunication? source]) {
...
class _ServerDbUser implements QueryExecutorUser {
  final ServerNetworkImplementation _server;
  final DriftNetworkCommunication connection;
  @override
